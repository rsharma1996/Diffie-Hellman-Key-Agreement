...
"""
mypowerfunction:  a customizable exponential function for computing g^(A*b)mod p, exponentiation by squaring
...
ServerSharedSecret = pow(g, (250824256*4472),p)
print(" shared secret is this: ", ServerSharedSecret)
